(function ($) {
	...
	var myChart = new Chart(ctx, {
		type: 'line',
		data: {
			labels: ["شهریور", "آبان", "آذر", "دی", "بهمن", "اسفند"],
			datasets: [{
					label: "فروش",
					borderColor: "#e76c90",
	...
	$('.widget14').owlCarousel({
		...
		loop: false,
		smartSpeed:1000,
		navText: ['<i class="la la-angle-right" aria-hidden="true"></i>', '<i class="la la-angle-left" aria-hidden="true"></i>'],
		responsive: {
			768: {
				items: 3
			}
	...
	function getDate() {
		...
		var weekdayNames = ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه"]
		var ampm = " عصر ";
