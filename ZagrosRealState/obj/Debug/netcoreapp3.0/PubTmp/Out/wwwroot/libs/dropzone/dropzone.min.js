        ...
        return _inherits(b, a), _createClass(b, null, [{
            ...
            value: function () {
                this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                    ...
                    renameFile: null,
                    forceFallback: !1,
                    dictDefaultMessage: "جهت آپلود فایل، اینجا را کلیک کنید",
                    dictFallbackMessage: "کاربرگرامی: مرورگر شما از عملیات کشیدن و رها کردن پشتیبانی نمی کند",
                    dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
                    dictFileTooBig: "حجم فایل شما خیلی بزرگ است ({{filesize}}MiB). حداکثر حجم فایل شما: {{maxFilesize}}MiB.",
                    dictInvalidFileType: "شما نمی توانید پرونده هایی از این نوع را بارگذاری کنید.",
                    dictResponseError: "کاربرگرامی: درخواست شما برای ارسال به سرور قابل تشخیص نمی باشد. کد خطا : {{statusCode}}.",
                    dictCancelUpload: "عملیات آپلود متوقف شد.",
                    dictUploadCanceled: "عملیات آپلود لغو شد.",
                    dictCancelUploadConfirmation: "آیا مطمئن هستید که می خواهید این آپلود را لغو کنید؟",
                    dictRemoveFile: "فایل مورد نظر حذف شد.",
                    dictRemoveFileConfirmation: null,
                    dictMaxFilesExceeded: "کاربرگرامی: شما نمی توانید پرونده دیگری را آپلود نمایید",
                    dictFileSizeUnits: {
                        tb: "ترابایت",
                        gb: "گیگابایت",
                        mb: "مگابایت",
